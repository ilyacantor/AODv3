"""LLM facts database operations.

Extracted from Database class - lines 1082-1190 of original database_old.py.
"""
...
async def get_llm_fact(pool, tenant_id: str, entity_key: str) -> Optional[dict]:
...
async def get_llm_facts_batch(pool, tenant_id: str, entity_keys: list[str]) -> dict[str, dict]:
